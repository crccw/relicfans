...
class MuseumsControllerTest < ActionController::TestCase
  ...
  test "should create museum" do
    assert_difference('Museum.count') do
      post :create, museum: { exhibit_url: @museum.exhibit_url, home_url: @museum.home_url, name: @museum.name }
    end
  ...
  test "should update museum" do
    patch :update, id: @museum, museum: { exhibit_url: @museum.exhibit_url, home_url: @museum.home_url, name: @museum.name }
    assert_redirected_to museum_path(assigns(:museum))
  end
